...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{74D852A4-F1A4-D1BA-DC72-D9A09158D9BA}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      ...
      <Command>call mkdir &quot;D:\Projetos\nlw3\node_modules\sqlite3\lib\binding\node-v83-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;D:\Projetos\nlw3\node_modules\sqlite3\lib\binding\node-v83-win32-x64\node_sqlite3.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to D:/Projetos/nlw3/node_modules/sqlite3/lib/binding/node-v83-win32-x64\node_sqlite3.node</Message>
      <Outputs>D:\Projetos\nlw3\node_modules\sqlite3\lib\binding\node-v83-win32-x64\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{1268D1A9-6638-A2C6-F1B4-6AE11ED326C1}</Project>
